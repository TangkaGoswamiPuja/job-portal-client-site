      ...
      <div className="navbar bg-purple-200">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-purple-200 rounded-box w-52">
              {links}
            </ul>
          </div>
          <div className="flex gap-2 items-center">
            <img className='w-10' src="https://i.ibb.co/jycCYtc/job.png" alt="" />
            <a className="text-2xl font-bold text-purple-600	italic ">JOB HUNTER</a>
          </div>
        </div>
